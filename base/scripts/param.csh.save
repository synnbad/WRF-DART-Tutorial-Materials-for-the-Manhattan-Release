...
set EMAIL                   = sasare@fsu.edu                 # set this appropriately #%%%#
...
if ( $SUPER_PLATFORM == 'derecho') then
   ...
   set FILTER_NODES        = 8
   set FILTER_PROCS        = 320
   set ADVANCE_NODES       = 1
   set ADVANCE_PROCS       = 40
   set SLURM_TASKS_PER_NODE = 40
endif
