...
EOF
   ...
   # gribfile_b=/gpfs/home/sa24m/Research/DATA/ERA_5_input/level_dart_tuts.grib
   # gribfile_a=/gpfs/home/sa24m/Research/DATA/ERA_5_input/surface_dart_tuts2.grib
    gribfile_b=${BASE_DIR}/gfs.0p25.${datea}.f006.grib2
...
EOF
      ...
      echo "#SBATCH --time=00:05:00" >> script.sed
      ...
      echo "#SBATCH --nodes=${ADVANCE_NODES}" >> script.sed
      echo "#SBATCH --ntasks=${ADVANCE_PROCS}" >> script.sed
      echo "#SBATCH --ntasks-per-node=${SLURM_TASKS_PER_NODE}" >> script.sed
