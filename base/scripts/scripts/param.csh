...
# source /gpfs/research/software/python/anaconda38/etc/profile.d/conda.csh
...
set BASE_DIR         = /gpfs/home/sa24m/Research/base     # set this appropriately #%%%#
...
set DART_DIR          = /gpfs/home/sa24m/Research/DART                     # set this appropriately #%%%#
set WRF_DM_SRC_DIR    = /gpfs/home/sa24m/Research/WRFV4.5.2                    # set this appropriately #%%%#
set WPS_SRC_DIR       = /gpfs/home/sa24m/Research/WPSV4.5                      # set this appropriately #%%%#
set VAR_SRC_DIR       = /gpfs/home/sa24m/Research/WRFDA                    # set this appropriately #%%%#

# for generating wrf template files
set GEO_FILES_DIR     = /gpfs/home/sa24m/Research/WPSV4.5           # set this appropriately #%%%#
...
set SUPER_PLATFORM          = slurm
set COMPUTER_CHARGE_ACCOUNT = chipilskigroup_q                  # set this appropriately #%%%#
set EMAIL                   = sa24m@fsu.edu           # set this appropriately #%%%#
...
if ( $SUPER_PLATFORM == 'derecho') then
   ...
   set FILTER_QUEUE        = chipilskigroup_q
   set FILTER_TIME         = 00:25:00
   set FILTER_CORES        = 20
   set ADVANCE_QUEUE       = chipilskigroup_q
   set ADVANCE_TIME        = 00:18:00
   set ADVANCE_CORES       = 10
   set ADVANCE_PRIORITY    = normal
   set FILTER_NODES        = 2
   set FILTER_PROCS        = 20
   set ADVANCE_NODES	   = 3
   set ADVANCE_PROCS	   = 10
   set SLURM_TASKS_PER_NODE = 13
